...
def main():
    # Corrige un bug de compatibilité entre Python récent et la librairie
    # Telegram : on crée explicitement une "boucle asyncio" pour le thread
    # principal (sinon RuntimeError "no current event loop").
